...
$rules = @(
    ...
    @{ Name = "DN Button 1 DN2 Top"; Controller = "4bf0d189-4d2e-41fe-a6af-45a38be1bc88"; Button = "button1"; Shade = "6522a7b1-1ed2-4ef7-865f-a0b89777f056" },
    @{ Name = "DN Button 2 DN3 Top"; Controller = "4bf0d189-4d2e-41fe-a6af-45a38be1bc88"; Button = "button2"; Shade = "b45cbc98-a70d-484a-b9cb-c15477369f00" },
